...
UNSOLVED_LENGTH = 0
training_set = "./train_test/" + experiment_name + "_train.csv"
test_set = "./train_test/" + experiment_name + "_test.csv"
extract_file_from_hdf = "./result_extract/" + experiment_name + "_extract.csv"
xgboost_prediction = "./xgboost/data/" + experiment_name + "_" + experiment_mode + "_prediction"
